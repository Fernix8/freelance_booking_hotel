export const accessToken = () => {
    if (typeof window !== 'undefined') {
        const name = 'hotelbookingAccessToken=';
...
export const setAccessToken = (accessToken: string) => {
    ...
    document.cookie = `hotelbookingAccessToken=${accessToken};${expires};path=/;${window.location.protocol === 'https' ? 'secure;' : ''}`;
};
...
export const logOut = () => {
    document.cookie = 'hotelbookingAccessToken=; Max-Age=-99999999;';
};
